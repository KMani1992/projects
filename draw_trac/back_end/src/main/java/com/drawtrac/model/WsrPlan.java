...
@Entity
public class WsrPlan  implements DRAWCRUDInterface {
	...
	public WsrPlan(int id,int ticketId,Date from_date,Date to_date,String task_type,String unplanned,
			int hours_planned,int time_spent,int total_time_spent,int no_of_week_planned,
			String tl_approval,String tl_comments,String stl_approval,String stl_comments,String planned,
			String completed,int tagId,String closed)
	{	
		this.id=id;
	...
	public String getFrom_date() {
		return DT_FORMAT.format(from_date);
	}
	...
	public String getTo_date() {
		return DT_FORMAT.format(to_date);
	}
	...
	public String getLast_updated() {
		return DT_FORMAT.format(last_updated);
	}
